...
int main() {
    ...
    shared_ptr<Directory> d0( new Directory("dir0", nullptr));
    ...
    shared_ptr<Directory> d1 = d0->addDirectory(fileName[4]);
    shared_ptr<Directory> d2 = d0->addDirectory(fileName[5]);
    shared_ptr<Directory> d3 = d1->addDirectory(fileName[6]);
